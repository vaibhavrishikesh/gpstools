...
/** One launch tile on the Home dashboard (US-015). */
...
/**
 * Home dashboard (P2-US-015) — the launch destination. A clean navy+gold landing
 * screen with quick-access tiles for the app's core flows. "Reports" routes to the
 * Gallery, where the PDF photo-proof report export lives (US-017).
 *
 * [onTileClick] receives the destination route to navigate to (same single-top
 * navigation MainActivity uses for the bottom nav).
 */
@Composable
fun HomeScreen(
    ...
    Column(
        ...
        // 2x2 grid of tiles (two rows of two).
    ...
    Card(
        ...
        Column(
            ...
            Box(
                modifier = Modifier
                    .size(64.dp)
                    .background(BrandNavyLight, CircleShape),
